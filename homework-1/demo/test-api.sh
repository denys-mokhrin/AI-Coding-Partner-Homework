...
curl -s -X POST $BASE_URL/transactions \
  ...
  -d '{"fromAccount":"ACC-00000","toAccount":"ACC-12345","amount":1000,"currency":"USD","type":"deposit"}'
echo -e "\n"
...
curl -s -X POST $BASE_URL/transactions \
  -H "Content-Type: application/json" \
  -d '{"fromAccount":"ACC-12345","toAccount":"ACC-00000","amount":100,"currency":"EUR","type":"withdrawal"}'
echo -e "\n"
...
curl -s -X POST $BASE_URL/transactions \
  -H "Content-Type: application/json" \
  -d '{"fromAccount":"INVALID","toAccount":"ACC-67890","amount":100,"currency":"USD","type":"transfer"}'
echo -e "\n"
...
curl -s -X POST $BASE_URL/transactions \
  -H "Content-Type: application/json" \
  -d '{"fromAccount":"ACC-12345","toAccount":"ACC-67890","amount":100,"currency":"FAKE","type":"transfer"}'
echo -e "\n"
